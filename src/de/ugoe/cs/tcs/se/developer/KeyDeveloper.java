...
public class KeyDeveloper extends SEDeveloper {
	
	public KeyDeveloper(double commitsPerRound,  CommitProbabilities cp, Parameters params) {
		super(commitsPerRound, cp, params);
	}

	public KeyDeveloper(double commitsPerRound, CommitProbabilities cp, Parameters params, UUID objectID, String name, boolean maintainer) {
	...
	public double computeFixProbability() {
		...
		return cd.getKeyDeveloperFixes() * 1.0 / cd.getKeyDeveloperCommits() * 1.0;
	}
